...
const Hero = () => {
  return (
    <section
      className="pattern-section relative flex min-h-screen items-center pt-20 py-24"
      id="home"
    >
      <div className="relative z-10 mx-auto grid max-w-7xl items-center gap-12 px-6 md:grid-cols-2">
        <div className="order-2 space-y-8 md:order-1">
          ...
          <h1 className="text-4xl leading-[1.1] font-black tracking-tight text-foreground-light/90 dark:text-foreground-dark md:text-6xl">
            Building Digital{" "}
          ...
          <p className="max-w-lg text-lg leading-relaxed text-foreground-light/50 dark:text-foreground-dark/50 md:text-xl">
        ...
        <div className="relative order-1 md:order-2">
          <div className="relative mx-auto aspect-square w-full max-w-md">
            ...
            <div className="absolute inset-0 -rotate-3 overflow-hidden rounded-4xl border border-slate-200 dark:border-slate-800 bg-background-light dark:bg-background-dark shadow-2xl">
              <Image
                alt="Elvis Sylvano Portrait"
                fill
